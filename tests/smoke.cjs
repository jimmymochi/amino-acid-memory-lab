...
(async () => {
 ...
 console.log('PASS: 21 entries and structure assets; canvas undo/redo/resize; paper toggle; text grading; persistent progress; wrong-answer retry; filters/search; full 21-question exam = 100/100 + 5/5; mobile no overflow; no browser errors.');
 await browser.close();
